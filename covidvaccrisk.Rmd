...
paramdata <- tibble(Impfdosen=round(c(dosen, dosen/3, dosen/3, dosen/3)),
                    ...
                    "angenommenes Sinusvenenthrombose-Risiko"=c(7/1.6e6,7/1.6e6,1/1.6e6,1/1.6e6),
